...
iriss_semantic_similarities <- read_csv("../../data/iriss_semantic_similarities.csv") %>% 
    mutate(condition=case_when(condition=="low-agency"~"Low-Agency",
                             condition=="high-agency"~"High-Agency",
                             condition=="Control"~"Control"))
...
According to the linear mixed model, participants in the low-agency condition produce significantly more similar ideas than the Control group.
